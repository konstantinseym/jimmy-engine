...
export default function LastPostPreview({ postData }) {
  return (
    <article className="border-palette-white/5 relative mx-4 mb-4 flex flex-col overflow-hidden rounded-4xl border bg-linear-to-br from-black/5 to-black/1 shadow-[0_8px_32px_rgba(0,0,0,0.12),inset_0_1px_0_rgba(255,255,255,0.2)] lg:flex-row">
      ...
      <div className="z-10 flex flex-col justify-around gap-4 p-8 lg:w-2/3">
